-- ============================================================
-- 00044_fixture_emission_ledger_event_type.sql
--
-- Phase 1.5: extend the `kinetiks_ledger_event_type_valid` CHECK
-- constraint (introduced in 00042 with NOT VALID) to include the
-- two fixture event types written by the fixture emitter:
--
--   - `fixture_emission`  one-per-emission provenance marker
--   - `fixture_cleanup`   archive-on-demand summary
--
