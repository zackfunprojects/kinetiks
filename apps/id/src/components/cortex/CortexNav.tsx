...
const NAV_ITEMS = [
  ...
  // Patterns sits between Goals and Integrations per the seven-section
  // Cortex sub-nav described in CLAUDE.md (Identity → Goals → Budget →
  // Patterns → Authority → Integrations → Ledger). Budget and Authority
  // join in their respective phases.
